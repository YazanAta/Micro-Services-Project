...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.microservices.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.microservices.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
