...
import com.microservices.servicetwo.service.PaymentService;
...
/**
 * REST controller for managing {@link com.microservices.servicetwo.domain.Payment}.
 */
@RestController
...
public class PaymentResource {
    ...
    private static final String ENTITY_NAME = "servicetwoPayment";
     ...
     */
    @GetMapping("")
    public List<Payment> getAllPayments(@RequestParam(name = "filter", required = false) String filter) {
        if ("order-is-null".equals(filter)) {
            LOG.debug("REST request to get all Payments where order is null");
            return paymentService.findAllWhereOrderIsNull();
        }
