...
import static com.microservices.servicetwo.domain.OrderItemAsserts.*;
...
import com.microservices.servicetwo.domain.OrderItem;
import com.microservices.servicetwo.repository.OrderItemRepository;
...
class OrderItemResourceIT {
    ...
    void partialUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.price(UPDATED_PRICE);
