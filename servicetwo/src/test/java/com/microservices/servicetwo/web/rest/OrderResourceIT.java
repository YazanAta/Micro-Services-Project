...
import static com.microservices.servicetwo.domain.OrderAsserts.*;
import static com.microservices.servicetwo.web.rest.TestUtil.createUpdateProxyForBean;
import static com.microservices.servicetwo.web.rest.TestUtil.sameNumber;
...
import com.microservices.servicetwo.domain.enumeration.OrderStatus;
import com.microservices.servicetwo.repository.OrderRepository;
import com.microservices.servicetwo.service.OrderService;
...
class OrderResourceIT {
    ...
    public static Order createEntity() {
        return new Order().orderDate(DEFAULT_ORDER_DATE).status(DEFAULT_STATUS).totalAmount(DEFAULT_TOTAL_AMOUNT);
    }
    ...
    public static Order createUpdatedEntity() {
        return new Order().orderDate(UPDATED_ORDER_DATE).status(UPDATED_STATUS).totalAmount(UPDATED_TOTAL_AMOUNT);
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.orderDate(UPDATED_ORDER_DATE).status(UPDATED_STATUS).totalAmount(UPDATED_TOTAL_AMOUNT);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.orderDate(UPDATED_ORDER_DATE).status(UPDATED_STATUS).totalAmount(UPDATED_TOTAL_AMOUNT);
